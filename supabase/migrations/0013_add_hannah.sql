-- Add ninth persona "hannah" to all persona check constraints.
-- Mirrors the pattern in 0005_add_personas.sql.
...
alter table public.deliveries add constraint deliveries_persona_check
  check (persona in ('andrea','emma','olivia','mia','abby','diane','sydney','maddy','hannah'));
